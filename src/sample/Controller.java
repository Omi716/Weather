    ...
    void initialize() {
        ...
        getData.setOnAction(event -> {
            ...
            if(!getUserCity.equals("")) { // Если данные не пустые
                ...
                String output = getUrlContent("http://api.openweathermap.org/data/2.5/weather?q=" + getUserCity + "&appid=eb08901fcd84d82cba3701517e61b0a9&units=metric");
                ...
                if (!output.isEmpty()) { // Нет ошибки и такой город есть
                    ...
                    temp_pres.setText("Давление: " + obj.getJSONObject("main").getDouble("pressure"));
                }
            }
        });
    }
